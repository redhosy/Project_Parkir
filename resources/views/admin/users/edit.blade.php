...
@section('title', 'Edit Pengguna - SmartPark')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            class="btn-modern group relative overflow-hidden px-6 py-3 rounded-xl bg-indigo-500 hover:bg-indigo-600 transform hover:scale-105 transition-all duration-300">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Data Pengguna</h2>
        </div>
        <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Password <small class="font-normal text-gray-500 dark:text-gray-400">(Biarkan kosong jika tidak ingin mengubah)</small>
                        </label>
                        <div class="relative">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        avatarInput.addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                // Restore original avatar or default icon
                @if($user->avatar)
                avatarPreview.innerHTML = `<img src="{{ $user->avatar_url }}" class="w-full h-full object-cover" alt="{{ $user->name }}">`;
                @else
